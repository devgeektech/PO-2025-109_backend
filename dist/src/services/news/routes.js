...
exports.default = [
    {
        ...
        handler: [
            ...
            (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
                const result = yield (0, controller_1.createNews)(req, res, next);
    ...
    },
    {
        ...
        handler: [
            (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
                const result = yield (0, controller_1.getAllNews)(req, next);
                res.status(200).send(result);
            }),
        ],
    },
    ...
    },
    {
        ...
        handler: [
            common_middleware_1.checkAuthenticate,
            (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
                const result = yield (0, controller_1.getNewsInsights)(next);
                res.status(200).send(result);
            }),
        ],
    },
    ...
    },
    {
        ...
        handler: [
            common_middleware_1.checkAuthenticate,
            (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
                const result = yield (0, controller_1.updateNews)(req, next);
                res.status(200).send(result);
            }),
        ]
    },
    {
        ...
        handler: [
            common_middleware_1.checkAuthenticate,
            (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
                const result = yield (0, controller_1.deleteNews)(req, next);
                res.status(200).send(result);
            }),
        ]
    },
